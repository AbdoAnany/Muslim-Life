              ...
              children: List.generate(_sortedElements.length, (index) {
                {
                  ...
                  if (actualIndex + 1 == _sortedElements.length) {
                    ...
                    return Column(
                      ...
                      WidgetAnimator(
                      child:    Text(
                          x,    style:  TextStyle(fontSize: widget.fontSize,color: Colors.blueGrey.shade900),
                          textDirection: TextDirection.rtl,textAlign: TextAlign.center,softWrap: true,overflow: TextOverflow.fade,
                        ),),
                WidgetAnimator(
                child:    _buildGroupSeparator(_sortedElements[actualIndex]),),
                ...
                child:     Text(
                  ...
                  if (actualIndex != 0) {
                    ...
                    if (prev != curr) {
                      ...
                      return Column(
                        children: [
                          Text(x,  style: TextStyle(fontSize: widget.fontSize,color: Colors.blueGrey.shade900), textDirection: TextDirection.rtl,textAlign: TextAlign.center,softWrap: true,//overflow: TextOverflow.fade,
                          ),
